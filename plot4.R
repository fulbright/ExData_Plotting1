...
par(mfrow = c(2, 2))
plot(date2, data$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")
plot(date2, data$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
...
plot(date2, data$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
